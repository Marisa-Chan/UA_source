...
void NC_STACK_winp::initfirst()
{
    ...
    SDLtoVK[SDL_SCANCODE_LSHIFT]      = UAVK_LSHIFT;
    SDLtoVK[SDL_SCANCODE_RSHIFT]      = UAVK_RSHIFT;
    SDLtoVK[SDL_SCANCODE_LCTRL]       = UAVK_LCONTROL;
    SDLtoVK[SDL_SCANCODE_RCTRL]       = UAVK_RCONTROL;
