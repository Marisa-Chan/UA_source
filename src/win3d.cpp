...
bool NC_STACK_win3d::SetResolution(Common::Point res)
{
...
void NC_STACK_win3d::raster_func207(int id, TileMap *t)
{
    _tiles[id] = t;
}

TileMap *NC_STACK_win3d::raster_func208(int id)
{
    return _tiles[id];
}

int NC_STACK_win3d::raster_func208(TileMap *t)
{
    if ( t )
    {
        for (int i = 0; i < 256; i++)
...
void NC_STACK_win3d::raster_func210(const Common::FRect &arg)
{
...
void NC_STACK_win3d::raster_func211(const Common::Rect &arg)
{
...
size_t NC_STACK_win3d::raster_func217(SDL_Color color)
{
...
void NC_STACK_win3d::raster_func221(const Common::Rect &arg)
{
...
void NC_STACK_win3d::display_func261(int ID, UA_PALETTE &pal, int from, int num)
{
    for (int i = 0; i < num; i++)
        _field_300[ID][from + i] = pal[i];
}

void NC_STACK_win3d::display_func261(int ID, UA_PALETTE &pal)
{
    _field_300[ID] = pal;
}
...
UA_PALETTE * NC_STACK_win3d::display_func273(int paletteId)
{
...
void NC_STACK_win3d::SetPalette(UA_PALETTE &newPal)
{
...
void NC_STACK_win3d::SetPen(SDL_Color pen)
{
    _field_4 = pen;
}

UA_PALETTE *NC_STACK_win3d::GetPalette()
{
    return &_palette;
}

int16_t NC_STACK_win3d::GetWidth()
{
    return _width;
}

int16_t NC_STACK_win3d::GetHeight()
{
    return _height;
}
